...
function NoteArchive({ notes, onDelete, onMove }) {
  return (
    <div className="flex flex-wrap mt-9 mx-auto lg:w-auto sm:w-full max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow">
      <div>
        ...
        <div className="flex justify-center">
          ...
          <button
          onClick={() => onMove(notes.id)}
          className="bg-blue-200 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Pindahkan</button>
        </div>
      </div>
    </div>
  );
